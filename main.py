...
# ---- Button Setup (GP21,22,24,25,26,27 - active LOW with PULL_UP) ----
BUTTONS = {
    "Random":   Pin(21, Pin.IN, Pin.PULL_UP),
    "Next":     Pin(22, Pin.IN, Pin.PULL_UP),
    "Previous": Pin(24, Pin.IN, Pin.PULL_UP),
    "Pause":    Pin(25, Pin.IN, Pin.PULL_UP),
    "Vol Up":   Pin(26, Pin.IN, Pin.PULL_UP),
    "Vol Down": Pin(27, Pin.IN, Pin.PULL_UP),
}
...
print("GP21=Random(Red)  GP22=Next(Black)  GP24=Prev(Black)  GP25=Pause(Blue)  GP26=Vol+(White)  GP27=Vol-(White)")
